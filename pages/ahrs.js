...
//         // Assuming the array contains [heading, pitch, roll]
//         // Adjust the order if needed based on your actual data
//         const parsedData = {
...
//           // Keep only the last 50 timestamps (seconds)
//           return newTimestamps.slice(-50);
//         });

//         setRollData((prev) => {
//           const newRollData = [...prev, parsedData.Roll];
//           // Keep only the last 50 values
//           return newRollData.slice(-50);
//         });

//         setPitchData((prev) => {
//           const newPitchData = [...prev, parsedData.Pitch];
//           // Keep only the last 50 values
//           return newPitchData.slice(-50);
//         });

//         setYawData((prev) => {
//           const newYawData = [...prev, parsedData.Heading]; // Using Heading as Yaw
//           // Keep only the last 50 values
//           return newYawData.slice(-50);
//         });
...
//       return `${timestamp},${rollData[index] || ""},${pitchData[index] || ""},${yawData[index] || ""}`;
//     });
...
//           <button
//             onClick={downloadCSV}
//             className="px-6 py-2 bg-teal-500 hover:bg-teal-400 text-white rounded-lg shadow-md font-semibold"
//           >
//             Download CSV
//           </button>
//         </div>
...
//         data={[
//           {
//             x: timestamps.length > 0 
//               ? timestamps.map((t) => t - timestamps[0]) // Adjust time to relative (0 to 50 seconds)
//               : [],
//             y: data,
//             type: "scatter",
//             mode: "lines+markers",
...
//             range: [0, 50], // Fix the x-axis range to 0-50 seconds
//           },
//           yaxis: {
//             title: yAxisLabel,
//             color: "#ffffff",
