    ...
    <div className={`min-h-screen ${darkMode ? "bg-gray-950 text-gray-100" : "bg-gray-50 text-gray-900"} font-sans p-6 transition-colors duration-300`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className={`p-5 rounded-xl shadow-lg h-full ${darkMode ? "bg-gray-900 border border-gray-800" : "bg-white border border-gray-200"}`}>
            <h2 className="text-lg font-semibold flex items-center gap-2 mb-4">
              <IconGauge className={`h-5 w-5 ${darkMode ? "text-blue-400" : "text-blue-500"}`} />
              AHRS Orientation
            </h2>
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              <div className={`p-2 rounded-lg text-center ${darkMode ? "bg-gray-800" : "bg-gray-100"}`}>
                <p className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Roll</p>
                <p className={`text-lg font-mono ${darkMode ? "text-red-400" : "text-red-600"}`}>
                  {orientation.roll.toFixed(1)}°
                </p>
              </div>
              <div className={`p-2 rounded-lg text-center ${darkMode ? "bg-gray-800" : "bg-gray-100"}`}>
                <p className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Pitch</p>
                <p className={`text-lg font-mono ${darkMode ? "text-blue-400" : "text-blue-600"}`}>
                  {orientation.pitch.toFixed(1)}°
                </p>
              </div>
              <div className={`p-2 rounded-lg text-center ${darkMode ? "bg-gray-800" : "bg-gray-100"}`}>
                <p className={`text-xs ${darkMode ? "text-gray-400" : "text-gray-600"}`}>Yaw</p>
              ...
              <Link 
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm ${
                  darkMode 
                    ...
                    : "bg-blue-500 hover:bg-blue-400 shadow-lg hover:shadow-blue-400/20"
                }`}
              >
