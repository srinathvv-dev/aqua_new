...
export default function Dashboard() {
  ...
  const sendThrusterCommandToROS = async (thrusterCommands) => {
    ...
    // In a real implementation, you would send this to ROS via WebSocket or API
    console.log("Sending thruster commands to ROS:", thrusterCommands);
    
    // Example of how you might send this via an API:
    /*
    try {
      await axios.post('/api/thrusters', {
        commands: thrusterCommands
      });
    } catch (error) {
      console.error("Failed to send thruster commands:", error);
      throw error;
    }
    */
    
    // Or via ROS WebSocket:
    /*
    const ros = createRosWebSocket();
    const cmd = new ROSLIB.Message({
      thrusters: thrusterCommands
    });
  ...
  const getPresetButtonClass = (presetName) => {
    ...
    if (isActive) {
      return `${baseClass} bg-blue-600 hover:bg-blue-500 shadow-lg shadow-blue-500/20`;
    }
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 font-sans p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          {/* ROS Status Card */}
          <div className="p-5 rounded-xl bg-gray-900 border border-gray-800 shadow-lg">
            ...
            {sensors.map((sensor, index) => (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <p className="text-[0.65rem] opacity-60">{sensor.unit}</p>
                </div>
              </Link>
            ))}
          </div>
        ...
        <div className="space-y-6">
          <div className="p-5 rounded-xl bg-gray-900 border border-gray-800 shadow-lg h-full">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold flex items-center gap-2">
                <IconCamera className="h-5 w-5 text-blue-400" />
                Camera Feed
              </h2>
            ...
            <div className="bg-black rounded-lg aspect-video flex items-center justify-center border border-gray-800">
              <div className="text-center p-4">
                <IconCamera className="h-12 w-12 text-gray-700 mx-auto mb-2" />
                <p className="text-sm text-gray-500">Camera feed will appear here</p>
                <p className="text-xs text-gray-600 mt-1">1920x1080 @ 30fps</p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="p-5 rounded-xl bg-gray-900 border border-gray-800 shadow-lg">
            <h2 className="text-lg font-semibold flex items-center gap-2 mb-4">
              <IconPropeller className="h-5 w-5 text-blue-400" />
              Thruster Controls
            </h2>
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link href="/CombinedGraphPage" className="p-3 bg-gray-900 hover:bg-gray-800 rounded-lg border border-gray-800 flex items-center gap-2 transition-colors">
              <IconChartBar className="h-4 w-4 text-blue-400" />
              <span className="text-sm">Graphs</span>
            </Link>
            <Link href="/operations" className="p-3 bg-gray-900 hover:bg-gray-800 rounded-lg border border-gray-800 flex items-center gap-2 transition-colors">
              <IconActivity className="h-4 w-4 text-emerald-400" />
              <span className="text-sm">Operations</span>
            </Link>
            <Link href="/settings" className="p-3 bg-gray-900 hover:bg-gray-800 rounded-lg border border-gray-800 flex items-center gap-2 transition-colors">
